...
const egg_construct = (() => {
    ...
    const loggers = { "echo": __debug("echo"), "fmt": __debug("fmt"), "exit": __debug("exit"), "branch": __debug("branch"), "goto": __debug("goto"), "add": __debug("add"), "+": __debug("+"), "subtract": __debug("subtract"), "-": __debug("-"), "multiply": __debug("multiply"), "*": __debug("*"), "pow": __debug("pow"), "**": __debug("**"), "divide": __debug("divide"), "/": __debug("/"), "reverse": __debug("reverse"), "rev": __debug("rev"), "mod": __debug("mod"), "include": __debug("include") };
    const _ = loggers;
    const debug = ((...g) => {
        log(...g);
    });
