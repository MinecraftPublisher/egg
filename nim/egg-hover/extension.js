...
function activate(context) {
    ...
    let disposable = vscode.commands.registerCommand('egg-hover.helloWorld', function () {
        // The code you place here will be executed every time your command is executed
        // Display a message box to the user
        vscode.window.showInformationMessage('Hello World from egg-hover!');
    });

    context.subscriptions.push(disposable);

    vscode.languages.registerHoverProvider('egg', {
        /**
         * 
